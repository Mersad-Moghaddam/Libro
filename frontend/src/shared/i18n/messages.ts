...
export const messages = {
  en: {
    ...
    auth: {
      ...
      signUp: 'Sign up',
      logIn: 'Log in',
      registerSubtitle: 'Set up your reading workspace with mobile-first sign in.',
      ...
      invalidCredentials: 'Mobile number or password is incorrect. Please try again.',
      mobileAlreadyExists: 'An account with this mobile number already exists.',
  ...
  fa: {
    ...
    auth: {
      ...
      signUp: 'ثبت‌نام',
      logIn: 'ورود',
      registerSubtitle: 'فضای مطالعه‌ات را با ورود مبتنی بر موبایل راه‌اندازی کن.',
      loginSubtitle: 'با شماره موبایل و رمز عبورت وارد شو.',
      ...
      mobileAlreadyExists: 'حسابی با این شماره موبایل از قبل وجود دارد.',
    ...
    validation: {
      ...
      mobileRequired: 'شماره موبایل را وارد کن.',
      validMobile: 'شماره موبایل معتبر وارد کن.',
      ...
      newPasswordMin: 'رمز عبور جدید باید حداقل ۸ کاراکتر باشد.',
